            ...
            <div
                ...
                <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                    <div class="flex flex-wrap items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-800">Корисници</h3>
                    ...
                    <table class="w-full mt-4 text-left table-auto min-w-max">
                        <thead>
                            <tr>
                                ...
                                <th
                                    class="p-4 transition-colors cursor-default border-y border-slate-200 bg-slate-50 hover:bg-slate-100">
                                    <h1 class="capitalize font-medium text-sm">Email</h1>
                                </th>
                                <th
                                    class="p-4 transition-colors cursor-default border-y border-slate-200 bg-slate-50 hover:bg-slate-100">
                                    <h1 class="capitalize font-medium text-sm">Последнот пат виден:</h1>
                                </th>
                            ...
                            @foreach ($users->where('role_id', '2') as $user)
                                ...
                                <tr class="border-b">
                                    ...
                                    <td class="p-4 border-b border-slate-200">
                                        <p class="text-sm font-semibold text-slate-700">{{ $user->name }}
                                            {{ $user->surname }}</p>
                                    </td>
                                    <td class="p-4 border-b border-slate-200">
                                        {{ $user->email }}
