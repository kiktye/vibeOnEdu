        ...
        <div class="relative flex flex-col w-full h-full text-slate-700 bg-white shadow-md rounded-xl bg-clip-border">
            <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                <div class="flex flex-wrap items-center justify-between">
                    <h3 class="text-lg font-semibold text-slate-800">Теми</h3>
                        ...
                        @foreach ($topics as $topic)
                            <tr class="border-b">
                                <td class="p-4 border-b border-slate-200">
                                    <p class="text-sm font-semibold text-slate-700">{{ $topic->name }}</p>
                                </td>
                                ...
                                <td class="p-4 border-b border-slate-200">
                                 <div class="flex items-center space-x-4">
                                     ...
                                     <!-- Modal toggle -->
                                     <button data-modal-target="edit-modal-{{ $topic->id }}"
                                         data-modal-toggle="edit-modal-{{ $topic->id }}"
                                     ...
                                     <!-- Main modal -->
                                     <div id="edit-modal-{{ $topic->id }}" tabindex="-1" aria-hidden="true"
                                         class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                         <div class="relative p-4 w-full max-w-md max-h-full">
                                             <!-- Modal content -->
                                             <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                     ...
                                     <form class="space-y-0" method="POST"
                                         ...
                                         onsubmit="return confirm('Дали си сигурен дека сакаш да ja избришеш оваа тема?');">
                                         @method('DELETE')
                                         @csrf

                                         <button class="text-xs font-semibold border-b-2 border-red-600"
                                             type="submit">Избриши тема</button>
                                     </form>
                                 </div>
                             </td>
                            </tr>
