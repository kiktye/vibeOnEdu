            ...
            <div
                ...
                <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
                    ...
                    <div class="flex flex-wrap items-center justify-between">
                        <h3 class="text-lg font-semibold text-slate-800">Материја</h3>
                        ...
                        <div id="crud-modal" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <!-- Modal body -->
                                    <form action="{{ route('materials.store') }}" method="POST" class="p-5">
                                        @csrf

                                        <!-- Course ID (Dropdown) -->
                                        <div class="mb-4">
                                            <label for="lecture_id"
                                                   class="block text-gray-700 text-sm font-bold mb-2">Material</label>
                                            <select name="lecture_id" id="lecture_id"
                                                    class="form-select block w-full mt-1">
                                                <option value=""> Одбери Материја</option>
                                                @foreach ($lectures->take(5) as $lecture)
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="material_id" id="material_id"
                                                    class="form-select block w-full mt-1">
                                                <option value=""> Одбери тип на материја</option>
                                        ...
                                        <div class="mb-4">
                                            <label for="content"
                                                   class="block text-gray-700 text-sm font-bold mb-2">Material
                                                Content</label>
                    ...
                    <table class="w-full mt-4 text-left table-auto min-w-max">
                        ...
                        <tr>
                            <th
                                ...
                                <h1 class="capitalize font-medium text-sm">Тип</h1>
                            </th>
                            <th
                                class="p-4 transition-colors cursor-default border-y border-slate-200 bg-slate-50 hover:bg-slate-100">
                                <h1 class="capitalize font-medium text-sm">Содржина</h1>
                            </th>
                        ...
                        @foreach ($materials as $material)
                            <tr class="border-b">
                                ...
                                <td class="p-4 border-b border-slate-200">
                                    <p class="text-sm font-semibold text-slate-700">{{ $material->type }}</p>
                                </td>
                                <td class="p-4 border-b border-slate-200">
                                    {{ $material->content }}
                                </td>
                                ...
                                <td class="p-4 border-b border-slate-200">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <!-- Modal toggle -->
                                        <button data-modal-target="edit-modal-{{ $material->id }}"
                                                data-modal-toggle="edit-modal-{{ $material->id }}"
                                        ...
                                        <!-- Main modal -->
                                        <div id="edit-modal-{{ $material->id }}" tabindex="-1"
                                             aria-hidden="true"
                                             class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                <!-- Modal content -->
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <div class="grid gap-4 mb-4 grid-cols-2">
                                                            ...
                                                            <div class="col-span-2">
                                                                <label for="material_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Тип</label>
                                                                <select name="material_id" id="material_id"
                                                                        class="form-select block w-full mt-1">
                                                                    <option value="" > Одбери тип на материја </option>
                                                                    @foreach ($materials as $material)
                                                            ...
                                                            <div class="col-span-2">
                                                                <label for="content"
                                                                       class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Содржина
                                                                </label>
                                                                <textarea id="content" name="content" rows="4"
                                                                          class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                                          placeholder="Напиши опис на беџ">{{ old('content', $material->content) }}</textarea>
                                                            </div>
                                                        </div>
                                                        <button type="submit"
                                        ...
                                        <form class="space-y-0" method="POST"
                                              ...
                                              onsubmit="return confirm('Дали си сигурен дека сакаш да ja избришеш оваа Материја ?');">
                                            @method('DELETE')
                                            @csrf
