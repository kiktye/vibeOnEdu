...
{{--                                        <!-- Main modal -->--}}
{{--                                        <div id="edit-modal-{{ $module->id }}" tabindex="-1"--}}
{{--                                             aria-hidden="true"--}}
{{--                                             class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">--}}
{{--                                            <div class="relative p-4 w-full max-w-md max-h-full">--}}
{{--                                                <!-- Modal content -->--}}
                                        ...
                                        <div class="container mx-auto p-4">
                                            ...
                                            @if ($errors->any())
                                                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-4"
                                                     role="alert">
                                                    <strong class="font-bold">Whoops!</strong> There were some problems with your
                                                    input.
                                            ...
                                            <div class="mb-4">
                                                <label for="title" class="block text-gray-700 text-sm font-bold mb-2">Quiz
                                                    Title</label>
                                                <input type="text" name="title" id="title"
                                                       class="form-input block w-full mt-1" value="{{ old('title') }}" required>
                                            </div>
                                            ...
                                            <div class="mb-4">
                                                ...
                                                <textarea name="description" id="description"
                                                          class="form-input block w-full mt-1" required>{{ old('description') }}</textarea>
                                            </div>
                            ...
                            <tr class="border-b">
                                ...
                                <td class="p-4 border-b border-slate-200">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <!-- Edit Quiz Modal -->
                                        <div id="edit-modal-{{ $quiz->id }}" tabindex="-1" aria-hidden="true"
                                             class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                            <div class="relative p-4 w-full max-w-md max-h-full">
                                                <!-- Modal content -->
                                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                    ...
                                                    <form method="POST"
                                                        ...
                                                        <div class="mb-4">
                                                            <label for="description"
                                                                   class="block text-gray-700 text-sm font-bold mb-2">Description</label>
                                                            <textarea name="description" id="description"
                                                                      class="form-input block w-full mt-1" required>{{ $quiz->description }}</textarea>
                                                        </div>
